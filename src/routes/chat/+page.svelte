      ...
      <div class="space-y-4 text-sm leading-relaxed">
        ...
        <div>
          ...
          <ul class="list-disc ml-5">
            ...
            <li>The data stored is how many users visit the site and how long they stay (for resume purposes).</li>
            <li>Chat submissions along with the response generated by the AI are placed in the logs; this is to improve the model</li>
          </ul>
        </div>
        <div>
